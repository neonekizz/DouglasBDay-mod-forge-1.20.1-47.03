...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> PLUSHIE = registerBlock("plushie", () -> new Block(BlockBehaviour.Properties.copy(Blocks.WHITE_WOOL).sound(SoundType.WOOL)));
